...
Shader "Revealable Invisibility/RI Standard"
{
	Properties
	{
	...
	SubShader
	{
		...
		//Additionnal pass to force Z-Rendering, non-existent otherwise with transparent shaders
		Pass
		{
			ZWrite On
			ColorMask 0
		...
		void surf(Input IN, inout SurfaceOutputStandard o)
		{
			...
			fixed4 Revealed = Calculate_Reveal(Color, Position, _Hidable);

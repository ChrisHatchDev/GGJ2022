...
public partial class @XRIDefaultInputActions : IInputActionCollection2, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""LeftTrigger"",
                    ""type"": ""PassThrough"",
                    ""id"": ""c8830134-64d6-4467-a028-f50ddea01a3c"",
                    ""expectedControlType"": ""Axis"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""76fdd787-668e-4b8f-bc13-db8c8cbb7a8d"",
                    ""path"": ""<XRController>{LeftHand}/triggerPressed"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Generic XR Controller"",
                ...
                {
                    ""name"": """",
                    ""id"": ""1d466a61-f25b-4ae8-af81-08a607c39d59"",
                    ""path"": ""<Keyboard>/g"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""RightTrigger"",
                    ""type"": ""PassThrough"",
                    ""id"": ""da3db875-977b-41af-af46-11ed494699f0"",
                    ""expectedControlType"": ""Axis"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""b54e710b-b342-4103-96b9-7f5f2b62e43e"",
                    ""path"": ""<XRController>{RightHand}/triggerPressed"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Generic XR Controller"",
                ...
                {
                    ""name"": """",
                    ""id"": ""18bcf3c8-c6d8-4bf0-bd22-ff76fff2c0f6"",
                    ""path"": ""<Keyboard>/h"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        m_XRILeftHand_LeftTrigger = m_XRILeftHand.FindAction("LeftTrigger", throwIfNotFound: true);
        // XRI RightHand
        ...
        m_XRIRightHand_RightTrigger = m_XRIRightHand.FindAction("RightTrigger", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_XRILeftHand_LeftTrigger;
    public struct XRILeftHandActions
    {
        ...
        public InputAction @LeftTrigger => m_Wrapper.m_XRILeftHand_LeftTrigger;
        ...
        public void SetCallbacks(IXRILeftHandActions instance)
        {
            if (m_Wrapper.m_XRILeftHandActionsCallbackInterface != null)
            {
                ...
                @LeftTrigger.started -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnLeftTrigger;
                @LeftTrigger.performed -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnLeftTrigger;
                @LeftTrigger.canceled -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnLeftTrigger;
            }
    ...
    private readonly InputAction m_XRIRightHand_RightTrigger;
    public struct XRIRightHandActions
    {
        ...
        public InputAction @RightTrigger => m_Wrapper.m_XRIRightHand_RightTrigger;
        ...
        public void SetCallbacks(IXRIRightHandActions instance)
        {
            if (m_Wrapper.m_XRIRightHandActionsCallbackInterface != null)
            {
                ...
                @RightTrigger.started -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnRightTrigger;
                @RightTrigger.performed -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnRightTrigger;
                @RightTrigger.canceled -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnRightTrigger;
            }
    ...
    private int m_KeyboardStuffSchemeIndex = -1;
    public InputControlScheme KeyboardStuffScheme
    {
        get
        {
            if (m_KeyboardStuffSchemeIndex == -1) m_KeyboardStuffSchemeIndex = asset.FindControlSchemeIndex("KeyboardStuff");
            return asset.controlSchemes[m_KeyboardStuffSchemeIndex];
        }
    }
